					...
					<table class="table" style="margin:auto;text-align:center;">
						...
						<c:forEach items="${wordSearchResults }" var="word" varStatus="i">
							<tr>
								<td>${i.index + 1 }</td>
								<td>${word.name }</td>
								<td><a href="Main?userId=${userId }&username=${username }&wordId=${word.id }" target="_top"><button type="button" class="btn btn-primary">修改文档</button></a></td>
